...
theorem, power.
The potential energy of spring conservation of mechanical energy, conservative and nonconservative forces; motion in a vertical circle: Elastic and inelastic collisions in one and two
dimensions.
...
expansion; specific heat capacity, calorimetry; change of state, latent heat. Heat transferconduction, convection, and radiation.
...
Familiarity with the basic approach and observations of the experiments and activities: 7. Vernier calipers-its use to measure the internal and external diameter and depth of a vessel. 8. Screw gauge-its use to determine thickness/ diameter of thin sheet/wire. 9. Simple Pendulum-dissipation of energy by plotting a graph between the square of amplitude
and time. 10. Metre Scale - the mass of a given object by the principle of moments. 11. Young's modulus of elasticity of the material of a metallic wire. 12. Surf ace tension of water by capillary rise and effect of detergents, 13. Co-efficient of Viscosity of a given viscous liquid by measuring terminal velocity of a given
spherical body, 14. Speed of sound in air at room temperature using a resonance tube, 15. Specific heat capacity of a given (i) solid and (ii) liquid by method of mixtures. 16. The resistivity of the material of a given wire using a metre bridge. 17. The resistance of a given wire using Ohm's law. 18. Resistance and figure of merit of a galvanometer by half deflection method. 19. The focal length of;
(i) Convex mirror
(ii) Concave mirror, and
(ii) Convex lens, using the parallax method. 20. The plot of the angle of deviation vs angle of incidence for a triangular prism. 21. Refractive index of a glass slab using a travelling microscope. 22. Characteristic curves of a p-n junction diode in forward and reverse bias. 23. Characteristic curves of a Zener diode and finding reverse break down voltage. 24. Identification of Diode. LED,. Resistor. A capacitor from a mixed collection of such items. # CHEMISTRY
...
stoichiometry. ### ### UNIT 2: ATOMIC STRUCTURE
...
electronic configuration of elements, extra stability of half-filled and completely filled orbitals. ### ### UNIT 3: CHEMICAL BONDING AND MOLECULAR STRUCTURE
...
Elementary idea of metallic bonding. Hydrogen bonding and its applications. ### ### UNIT 4: CHEMICAL THERMODYNAMICS
...
significance. ### ### UNIT 6: EQUILIBRIUM
...
soluble salts and solubility products, buffer solutions. ### ### UNIT 7: REDOX REACTIONS AND ELECTRO# CHEMISTRY
...
potential and Gibbs' energy change: Dry cell and lead accumulator; Fuel cells. ### ### UNIT 8: CHEMICAL KINETICS
...
enthalpy, valence, oxidation states, and chemical reactivity. ### ### UNIT 10: P- BLOCK ELEMENTS
...
element in each group. ### ### UNIT 11: d - and f- BLOCK ELEMENTS
Transition Elements
...
Actinoids - Electronic configuration and oxidation states. ### ### UNIT 12: CO-ORDINATION COMPOUNDS
...
ORGANIC # CHEMISTRY ### ### UNIT 13: PURIFICATION AND CHARACTERISATION OF ORGANIC COMPOUNDS
...
quantitative analysis, ### ### UNIT 14:SOME BASIC PRINCIPLES OF ORGANIC # CHEMISTRY
...
- Cell theory and cell as the basic unit of life; Structure of prokaryotic and eukaryotic cell;
   Plant cell and animal cell; Cell envelope, cell membrane, cell wall; Cell organellesstructure and function; Endomembrane system-endoplasmic reticulum, Golgi bodies,
...
- Plant growth and development: Seed germination; Phases of Plant growth and plant
   ...
   redifferentiation; Sequence of developmental process in a plant cell; Growth regulatorsauxin, gibberellin, cytokinin, ethylene, ABA;
...
- Sexual reproduction in flowering plants: Flower structure; Development of male and
   ...
   endosperm and embryo, Development of seed and formation of fruit; Special modesapomixis, parthenocarpy, polyembryony; Significance of seed and fruit formation.
...
- Evolution: Origin of life; Biological evolution and evidences for biological evolution
   ...
   Darwin’s contribution, Modern Synthetic theory of Evolution; Mechanism of evolutionVariation (Mutation and Recombination) and Natural Selection with examples, types of
