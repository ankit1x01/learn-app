...
Q.1 Let L ℝ denote the set of all real numbers. Let 𝑎𝑖
, 𝑏𝑖 ∈ ℝ for 𝑖 ∈ {1, 2, 3}.
...
,
ℎ(𝑥) = 𝑓(𝑥 + 1) − 𝑔(𝑥 + 2).
If 𝑓(𝑥) ≠ 𝑔(𝑥) for every 𝑥 ∈ ℝ, then the coefficient of 𝑥
3
in ℎ(𝑥) is
(A) 8
(B) 2
...
Q.4 Consider the matrix 0
𝑃 = (
2 0 0
0 2 0
0 0 3
) .
Let the transpose of a matrix 𝑋 be denoted by 𝑋
𝑇
. Then the number of 3 × 3 invertible matrices 𝑄
...
(C) The area of Δ𝑃𝑄𝑅 is 3
2
√234
(D) The acute angle between the line segments 𝑃𝑄 and 𝑃𝑅 is cos−1
(
1
2√3
)
...
(C) 𝑆 is a circle with radius √2
3
(D) 𝑆 is a circle with radius 2√2
3
JEE (Advanced) 2025 Paper 1
5/9
...
Q.9 For any two points 𝑀 and 𝑁 in the 𝑋𝑌-plane, let 𝑀𝑁⃗⃗⃗⃗⃗⃗⃗ denote the vector from 𝑀 to 𝑁, and 0⃗ denote
...
• For each question, enter the correct numerical value of the answer using the mouse and the onscreen virtual numeric keypad in the place designated to enter the answer.
...
Q.13 For all 𝑥 > 0, let 𝑦1
(𝑥), 𝑦2
(𝑥), and 𝑦3(𝑥) be the functions satisfying
𝑑𝑦1
𝑑𝑥
− (sin 𝑥)
2 𝑦1 = 0, 𝑦1
...
the mean deviation about the median, and 𝜎
...
Match each entry in List-I to the correct entry in List-II and choose the correct option.
 List-I List-II
(P) The minimum value of 𝑛 for which the
 function
𝑓(𝑥) = [
10𝑥
3 − 45𝑥
...
(2) 9
(R) The smallest natural number 𝑛 which is
...
JEE (Advanced) 2025 Paper 1
9/9
Q.16 Let 𝑤⃗ = 𝑖̂+ 𝑗̂− 2𝑘̂, and 𝑢⃗ and 𝑣 be two vectors, such that 𝑢⃗ × 𝑣 = 𝑤⃗ and 𝑣 × 𝑤⃗ = 𝑢⃗ . Let
𝛼, 𝛽, 𝛾, and 𝑡 be real numbers such that
𝑢⃗ = 𝛼𝑖̂+ 𝛽𝑗̂+ 𝛾𝑘̂ , − 𝑡 𝛼 + 𝛽 + 𝛾 = 0, 𝛼 − 𝑡 𝛽 + 𝛾 = 0, and 𝛼 + 𝛽 − 𝑡 𝛾 = 0.
Match each entry in List-I to the correct entry in List-II and choose the correct option.
 List-I List-II
(P) |𝑣 |
2
...
2𝜋
𝜔
. The correct expression for 𝜔 is (𝑔 is the acceleration due to gravity):
(A) √
2
3
(
...
𝐵⃗ (𝑡) = 𝐵0
(cos 𝜔𝑡)𝑘̂, where 𝐵0 is a constant. The magnetic field is zero everywhere else. At time
...
JEE (Advanced) 2025 Paper 1
5/13
Q.5 A . conducting square loop of side 𝐿, mass 𝑀 and resistance 𝑅 is moving in the 𝑋𝑌 plane with its edges
parallel to the 𝑋 and 𝑌 axes. The region 𝑦 ≥ 0 has a uniform magnetic field, 𝐵⃗ = 𝐵0𝑘̂. The magnetic
field is zero everywhere else. At time 𝑡 = 0, the loop starts to enter the magnetic field with an initial
velocity 𝑣0𝑗̂m/s, as shown in the figure. Considering the quantity 𝐾 =
𝐵0
2𝐿
2
𝑅𝑀
...
is given by 𝑦 = 8 [1 + sin (
2𝜋𝑡
𝑇
)], where 𝑇 = 40𝜋 s. Taking acceleration due to gravity, 𝑔 = 10
m/s2
, the maximum variation of the object’s weight (in N) as observed in the experiment is ____
...
space 𝜇0 = 4𝜋 × 10−7 Tm/A, Planck’s constant ℎ = 6 × 10−34Js and 𝜋 =
22
7
, the value of 𝛼 is____
SECTION 3 (Maximum Marks: 24)
• This section contains SIX (06) questions.
• The answer to each question is a NUMERICAL VALUE.
• For each question, enter the correct numerical value of the answer using the mouse and the onscreen virtual numeric keypad in the place designated to enter the answer.
...
JEE (Advanced) 2025 Paper 1
9/13
Q.12 A single slit diffraction experiment is performed to determine the slit width using the equation,
𝑏𝑑
𝐷
=
...
this electron. If this temperature is given by 𝑇 =
𝑍
2ℎ
2
𝛼𝜋2𝑎0
2𝑚N𝑘B
, (where ℎ is the Planck’s constant, 𝑘𝐵
...
List-I List-II
(P) 𝐸 ∝ 𝑍
2 (1) energy of characteristic x-rays
(Q) 𝐸 ∝ (𝑍 − 1)
2
(2) electrostatic part of the nuclear binding
energy for stable nuclei with mass numbers in
the range 30 to 170
(R) 𝐸 ∝ 𝑍(𝑍 − 1)
(3) energy of continuous x-rays
(S) 𝐸 is practically independent of 𝑍
(4) average nuclear binding energy per nucleon
for stable nuclei with mass number in the range
30 to 170
...
(A) [Co(CN)6]
3− < [Co(NH3)6]
3+ < [Co(NH3)5(H2O)]3+ < [Co(NH3)5(Cl)]2+
(B) [Co(NH3)5(Cl)]2+ < [Co(NH3)5(H2O)]3+ < [Co(NH3)6]
3+ < [Co(CN)6]
3−
(C) [Co(CN)6]
3− < [Co(NH3)5(Cl)]2+ < [Co(NH3)5(H2O)]3+ < [Co(NH3)6]
3+
(D) [Co(NH3)6]
3+ < [Co(CN)6]
3− < [Co(NH3)5(Cl)]2+ < [Co(NH3)5(H2O)]3+
...
(C) Bond energy of O2
+ is smaller than the bond energy of O2.
...
JEE (Advanced) 2025 Paper 1
5/9
Q.8 In an electrochemical cell, dichromate ions in aqueous acidic medium are reduced to Cr3+
. The current
(in amperes) that flows through the cell for 48.25 minutes to produce 1 mole of Cr3+ is ______.
Use: 1 Faraday = 96500 C mol−1
Q.9 At 25 ℃, the concentration of H+
ions in 1.00 × 10−3 M aqueous solution of a weak monobasic acid
...
as a cubic equation with Vm as the variable. The ratio (in mol dm−3
) of the coefficient of 𝑉m
2
to the
coefficient of Vm for a gas having van der Waals constants a = 6.0 dm6 atm mol−2
and b = 0.060
dm3 mol−1
at 300 K and 300 atm is ______.
Use: Universal gas constant (R) = 0.082 dm3
atm mol−1 K
−1
...
Use: Universal gas constant (R) = 8.3 J K
−1 mol−1
...
O
HO
(1) Reaction with phenyl diazonium salt gives
yellow dye.
(Q)
H
N
...
OMe
O O
(2) Reaction with ninhydrin gives purple color
...
+Cl
−
(3) Reaction with glucose will give
