...
import { RELATIVE_MOTION_PUZZLES } from './puzzles/relative_motion.puzzles'
import { PSEUDO_FORCE_PUZZLES } from './puzzles/pseudo_force.puzzles'
import { THERMODYNAMICS_PUZZLES } from './puzzles/thermodynamics.puzzles'
import { WAVES_PUZZLES } from './puzzles/waves.puzzles'
import { GRAVITATION_PUZZLES } from './puzzles/gravitation.puzzles'
import { CURRENT_ELECTRICITY_PUZZLES } from './puzzles/current_electricity.puzzles'
import { CAPACITOR_PUZZLES } from './puzzles/capacitor.puzzles'
import { MAGNETISM_PUZZLES } from './puzzles/magnetism.puzzles'
import { EMI_PUZZLES } from './puzzles/emi.puzzles'
import { AC_PUZZLES } from './puzzles/ac.puzzles'
import { EM_WAVES_PUZZLES } from './puzzles/em_waves.puzzles'
import { PHOTOELECTRIC_PUZZLES } from './puzzles/photoelectric.puzzles'
import { CIRCULAR_MOTION_PUZZLES } from './puzzles/circular_motion.puzzles'
...
export const SIMULATION_REGISTRY: Record<SimulationType, SimulationPlugin> = {
  ...
  relative_motion: {
    ...
    puzzles: RELATIVE_MOTION_PUZZLES, label: 'Relative Motion', icon: 'compare_arrows',
    defaultControls: [
  ...
  pseudo_force: {
    ...
    puzzles: PSEUDO_FORCE_PUZZLES, label: 'Pseudo Force', icon: 'swap_horiz',
    defaultControls: [
