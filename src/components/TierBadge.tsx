...
export const TierBadge = ({ tier }: { tier: 1 | 2 | 3 | 4 }) => {
  ...
  return (
    <span className={`px-2 py-0.5 rounded-full text-[12px] font-bold uppercase tracking-normal flex items-center gap-1 ${
      tier === 1 ? 'bg-[#F5A623]/15 text-[#F5A623]' : 'bg-[#F0EEE9] text-[#6B7280]'
    }`}>
